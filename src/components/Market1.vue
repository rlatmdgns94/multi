      ...
      <div class="market_top">
        <div class="market_menu_area">
          ...
          <ul class="market_menu">
            ...
            <li>
              <router-link :to="{path: '/market/1', query: {sort: '-cdate'}}" class="on">반찬</router-link>
            </li>
            <li>
      ...
      <div class="market_bottom">
        <div class="product_category_area">
          <ul class="product_category">
            ...
            <li>
              <router-link
                :to="{name: 'Market1', query: {sort: 'price'}}"
            ...
            <li>
              <router-link
                :to="{name: 'Market1', query: {sort: '-cdate'}}"
                exact-active-class="active"
              >등록일순</router-link>
            </li>
          </ul>

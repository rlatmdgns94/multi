...
<div class="container">
    ...
    <div class="main_story">
        <div class="main_title_box">
            <h3 class="main_title">식과당 소개</h3>
            <p class="main_title_caption">식과당은 신뢰할 수 있는 당뇨 식단을 위해 노력하고 연구합니다.</p>
            <i class="ico_bar"></i>
        </div>
        <ul class="story_list">
            <li><router-link to="/"><img src="../assets/img/Introduce1.jpg" alt=""></router-link></li>
            <li><router-link to="/"><img src="../assets/img/Introduce2.jpg" alt=""></router-link></li>
            <li><router-link to="/"><img src="../assets/img/Introduce3.jpg" alt=""></router-link></li>             
        </ul>
    </div>
    <!-- 식과당 소개 -->
    <div class="main_program">
        <div class="main_title_box white">
            <h3 class="main_title">맞춤당 식단 프로그램</h3>
            <p class="main_title_caption">라이프 스타일과 당뇨 유형에 따라 식단을 구성했습니다.</p>
            <i class="ico_bar"></i>
        </div>
        <div class="program_box_area">
            ...
            <ul class="program_box">
                ...
                <li>
                    <img src="../assets/img/program3.jpg" alt="">
                </li>
            </ul>
        </div>
    </div>
     ...
     <div class="content">
         <div class="main_title_box">
            <h3 class="main_title">지피지기 당뇨 정보</h3>
            <p class="main_title_caption">지피지기 백전백승! 당뇨에 대해 더 자세히 알려드립니다.</p>
            <i class="ico_bar"></i>
        </div>
        <ul class="main_information">
            <li>
                <div class="information_box">
                    <div class="information_img"><img src="../assets/img/information1.jpg" alt=""></div>
                    <h4 class="information_title">당뇨에 좋은 음식은?</h4>
                    <p class="information_text">당뇨의 좋은 음식과 안 좋은 음식<br>어떤 것들이 있을까요?</p>
                    <router-link to="/" class="information_more">자세히 보기</router-link>                    
                </div>
            </li>
            <li>
                <div class="information_box">
                    <div class="information_img"><img src="../assets/img/information2.jpg" alt=""></div>
                    <h4 class="information_title">당뇨에 운동이 필요한 이유</h4>
                    <p class="information_text">ㄹㅁ이나러어미럼렁미럼 음식을<br>힐링푸드를 통해 알아보세요.</p>
                    <router-link to="/" class="information_more">자세히 보기</router-link>                    
                </div>
            </li>
            <li>
                <div class="information_box">
                    <div class="information_img"><img src="../assets/img/information3.jpg" alt=""></div>
...
.main_program{
    ...
    overflow: hidden;
    margin-top: 133px;
    background: url('../assets/img/program_bg.jpg') no-repeat center;
    .program_box_area{
        width: 822px;
        margin: 0 auto;
        margin-top: 30px;

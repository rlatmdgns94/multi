<template>
    <div class="jipijigi_wrap">
        <div class="jipijigi_keyimg"></div>
        <div class="content">
            <div class="jipijigi_nav">
                <h2 class="blind">지피지기 메뉴</h2>
                <ul class="jipijigi_gnb">
                    <li><router-link to="/" class="on">전체</router-link></li>
                    <li><router-link to="/">당뇨란?</router-link></li>
                    <li><router-link to="/">당뇨 음식</router-link></li>
                    <li><router-link to="/">당뇨 운동</router-link></li>
                </ul>
            </div>
            <div class="jpjigi_slide">
                <ul class="slide">
                    <li>
...
.jipijigi_keyimg {
    height: 284px;
    background: url("../assets/img/jipijigi_key.jpg") no-repeat center;
}
.jipijigi_nav{
    text-align: center;
}

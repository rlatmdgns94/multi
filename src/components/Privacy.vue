<template>
  <div class="email_wrap">
    <div class="content">
      <div class="email_top">
        <h2 class="unauthorized">개인정보처리방침</h2>
        <span class="right_text">HOME<span class="unauthorized_2">개인정보처리방침</span></span>
      </div>
      <div class="email_content">
        식과당은 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다. <br>
        ...
        - 회원가입시 : 이름 , 로그인ID , 비밀번호 , 휴대전화번호 , 이메일 , 14세미만 가입자의 경우 법정대리인의 정보<br>
        - 서비스 신청시 : 주소, 결제 정보<br>
        <br>
        ...
        o 귀하가 개인정보의 오류에 대한 정정을 요청하신 경우에는 정정을 완료하기 전까지 당해 개인정보를 이용 또는 제공하지 않습니다. 또한 잘못된 개인정보를 제3자에게 이미 제공한 경우에는 정정 처리결과를 제3자에게<br>
        ...
        회사는 귀하의 정보를 수시로 저장하고 찾아내는 “쿠키(cookie)” 등을 운용합니다. 쿠키란 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에
        저장됩니다.
        ...
        2. 귀하는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서, 귀하는 웹브라우저에서 옵션을 설정함으로써 모든 쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 아니면 모든 쿠키의 저장을 거부할 수도 
        있습니다.<br>
        o 쿠키 설정 거부 방법<br>
...
<br>
        ...
        경찰청 사이버안전국 (www.ctrc.go.kr/ 국번 없   이 182)
      </div>
    </div>
  </div>
</template>

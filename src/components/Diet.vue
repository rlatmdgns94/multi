			...
			<div class="diet_content on">
				<ul id="gallery">
					...
					<li>
						<div class="week_diet_wrap content">
							<div class="week_diet_top">
								<h3 class="week_diet_title">3월 2주차</h3>
								<p class="week_diet_text">메인 식단 표기, 드시려는 식단명을 클릭하셔서 상세정보를 확인하세요.</p>
							</div>
							<table class="week_diet">
								<caption class="blind">식단표</caption>
					...
					<li>
						<div class="week_diet_wrap content">
							<div class="week_diet_top">
								<h3 class="week_diet_title">3월 3주차</h3>
								<p class="week_diet_text">메인 식단 표기, 드시려는 식단명을 클릭하셔서 상세정보를 확인하세요.</p>
							</div>
							<table class="week_diet">
								<caption class="blind">식단표</caption>
					...
					<li>
						<div class="week_diet_wrap content">
							<div class="week_diet_top">
								<h3 class="week_diet_title">3월 4주차</h3>
								<p class="week_diet_text">메인 식단 표기, 드시려는 식단명을 클릭하셔서 상세정보를 확인하세요.</p>
							</div>
							<table class="week_diet">
								<caption class="blind">식단표</caption>
				...
				<div id="btn_gallery">
					<router-link to="#" class="btn_gallery_prev off"><img src="../assets/img/btn_prev.png" alt="이전버튼"></router-link>
					<router-link to="#" class="btn_gallery_next"><img src="../assets/img/btn_next.png" alt="다음버튼"></router-link>
				</div>
			</div>
			<!-- //식단표 -->
			<!-- 주문하기 -->
			<div class="diet_content">
				<div class="order_wrap">
					<ul class="diabetes_guide">
						<li>
							<span>
									<img src="../assets/img/check-form.png" alt>
								</span>
						</li>
						<li>
					...
					<div class="program_option">
						<form action>
							<div class="diabetes_option_box">
								<ul class="diabetes_guide diabetes_guide_v1">
									<li>
										<span class="step">Step2</span>
									</li>
									<li>
										<p class="guide_title">식단의 횟수를 선택해주세요.</p>
									</li>
									<li>
										<p>당뇨는 적절한 식사요법이 치료의 기본 요소입니다.</p>
									</li>
								</ul>
								<ul class="diabetes_option">
									<li>
										<span class="diabetes_option_title">하루에</span>
										<div class="option_box">
											<input type="radio" name="meal_qty_of_the_day" value="1meal" id="option_meal_qty" class="option_selected" :checked="mealsQty === '1meal'">
											<label for="option_meal_qty" class="diabetes_radio_btn">
												<span></span>2끼
											</label>
										</div>
										<div class="option_box">
											<input type="radio" name="meal_qty_of_the_day" value="2meal" id="option_meal_qty2" class="option_selected" :checked="mealsQty === '2meal'">
											<label for="option_meal_qty2" class="diabetes_radio_btn">
												<span></span>3끼
											</label>
										</div>
									</li>
									<li>
										<span class="diabetes_option_title">한 주에</span>
										<div class="option_box">
											<input type="radio" name="option_days_of_week" value="3days" id="option_days_of_week" class="option_selected" :checked="days === '3days'">
											<label for="option_days_of_week" class="diabetes_radio_btn">
												<span></span>3일
											</label>
										</div>
										<div class="option_box">
											<input type="radio" name="option_days_of_week" value="7days" id="option_days_of_week2" class="option_selected" :checked="days === '7days'">
											<label for="option_days_of_week2" class="diabetes_radio_btn">
												<span></span>5일
											</label>
										</div>
									</li>
									<li>
										<span class="diabetes_option_title">총 몇 주</span>
										<div class="option_box">
											<input type="radio" name="option_weeks" value="4weeks" id="option_weeks" class="option_selected" :checked="weeks === '4weeks'">
											<label for="option_weeks" class="diabetes_radio_btn">
												<span></span>1주
											</label>
										</div>
										<div class="option_box">
											<input type="radio" name="option_weeks" value="8weeks" id="option_weeks2" class="option_selected" :checked="weeks === '8weeks'">
											<label for="option_weeks2" class="diabetes_radio_btn">
												<span></span>2주
											</label>
										</div>
									</li>
								...
								<ul class="main_menu_option">
									<li>
										<div class="option_box">
											<img src="../assets/img/option1.png" alt>
											<input type="radio" name="option_meals" value="option1" id="option_meals" class="option_selected" :checked="options === 'option1'">
									...
									<li>
										<div class="option_box">
											<img src="../assets/img/option2.png" alt>
											<input type="radio" name="option_meals" value="option2" id="option_meals2" class="option_selected" :checked="options === 'option2'">
									...
									<li>
										<div class="option_box">
											<img src="../assets/img/option3.png" alt>
											<input type="radio" name="option_meals" value="option3" id="option_meals3" class="option_selected" :checked="options === 'option3'">
								...
								<ul class="early_serious_chronic">
									<li>
										<label>
										<input
											type="radio"
											...
											value="tuesday"
											class="button_like"
											:checked="delivery === 'tuesday'"
										>
										<span class="symptom_button">매주 화요일</span>
										</label>
									</li>
									<li>
										<label>
...
.diet_tab_area {
	position: relative;
	height: 350px;
	background: url('../assets/img/diet_bg.jpg') no-repeat;
}
...
.option_selected:checked+.diabetes_radio_btn span {
...
.payment_box {
	...
	font-size: 20px;
	font-family: "Noto Sans KR";
	box-shadow: 0px 3px 8px 1px rgba(133, 175, 75, 0.2);
	.payment_text {
		overflow: hidden;
		padding: 25px 58px;
...
export default {
	...
	mounted() {
		$(document).ready(function() {
			$('.diet_tab>li>a').on('click', function() {
